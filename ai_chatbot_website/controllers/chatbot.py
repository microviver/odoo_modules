...
class AIChatbotController(http.Controller):
    ...
    def ask_openai(self, **kwargs):
        try:
            ...
            # OpenAI setup
            client = OpenAI(api_key="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")  # MOVA para variável de ambiente!
